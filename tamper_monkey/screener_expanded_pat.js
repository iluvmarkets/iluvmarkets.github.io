...
(function () {
        ...
        cells.forEach((cell, index) => {
            ...
            if (Number.isFinite(value)) {
                ...
                if (value > 0) {
                    ...
                    //cell.style.color = `rgb(25, ${greenIntensity},25,0.7)`;

                    cell.style.backgroundColor = "#5fb881";
                    ...
                    //cell.style.color = `rgb(${redIntensity}, 25,25,0.7`;

                    cell.style.backgroundColor = "#b55043";
    ...
    const targetRow = Array.from(document.querySelectorAll('tr')).find(row =>
        ...
        row.querySelector('td.text')?.innerText.trim() === "Net Profit" ||

        row.querySelector(`button[onclick*="Net Profit"]`)

    );

    const button = $(targetRow).find('.text .button-plain');
    ...
    if (button){
     ...
     window.setTimeout(() => {
        ...
        applyConditionalFormatting("Profit after tax", true, true);
